...
namespace WinMonitorApp.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult ComponentandStatus(string commonCheck)
        {
            if (commonCheck == "CheckIfTrueErrorWin")
            {
                return View();
        ...
        public ActionResult PerformanceMetrics(string commonCheck)
        {
            if (commonCheck == "CheckIfTrueErrorWin")
            {
                return View();
        ...
        public ActionResult EditMaintenanceCalendar(string commonCheck)
        {
            if (commonCheck == "CheckIfTrueErrorWin")
            {
                return View();
