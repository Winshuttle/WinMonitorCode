...
function masterPageMetricsClicked() {
    $("#masterPageContentPlace").load("PerformanceMetrics/?commonCheck=CheckIfTrueErrorWin");
}

//pageload function when activate page tab clicked
function masterPageMaintenanceCalendarClicked() {
    $("#masterPageContentPlace").load("EditMaintenanceCalendar/?commonCheck=CheckIfTrueErrorWin");
}
...
//Component Page Functions
        ...
        function loadComponentsFromDB() {
            ...
            if (companyId !=null) {
                $.ajax({
                    ...
                    datatype: 'Json',
                    success: function (data) {
                        var primaryDataCenterOfCompany = data.DBPrimaryCenter;               //////'<img id="questionMarkImage" src="~/Images/questionMark.jpg" style="height:8px;width:8px"/>'
                        $.ajax({
    ...
    //JQuery to set primary data center 
