            ...
            if (($("#CompanyName").val()) && ($("#CompanyURL").val()) &&  primaryselect !="default" &&  secondaryselect !="default")
            {
                ...
                if (characterReg.test(inputVal)) {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        success: function (data) {
                            if (data == "DbUpdateException" || data == "DbEntityValidationException" || data == "NotSupportedException" || data == "ObjectDisposedException" || data == "InvalidOperationException" || data == "Misllaneous Exception")
                                alert(data);
                        },
